...
<head>
  ...
  <title>Подтверждение email — Dentcor</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="480" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:linear-gradient(135deg,#0097A7,#4A90D9);padding:36px 40px;text-align:center;">
              <div style="display:inline-flex;align-items:center;gap:10px;">
                ...
                <span style="color:#FFFFFF;font-size:24px;font-weight:700;letter-spacing:0.5px;">Dentcor</span>
              </div>
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 28px;color:#64748B;font-size:15px;line-height:1.6;">
                Для завершения регистрации в Dentcor введите код подтверждения в приложении:
              </p>
              ...
              <p style="margin:0;color:#94A3B8;font-size:13px;line-height:1.6;">
                Если вы не регистрировались в Dentcor, просто проигнорируйте это письмо.
              </p>
            </td>
          </tr>
          <tr>
            <td style="background:#F8FAFC;padding:20px 40px;text-align:center;border-top:1px solid #E2E8F0;">
              <p style="margin:0;color:#CBD5E1;font-size:12px;">© 2026 Dentcor. Ваш стоматологический помощник.</p>
            </td>
          </tr>
        </table>
      </td>
